...
/**
 * Barrierefreier Button mit großer Touchfläche für geriatrische Patienten
 * Erfüllt WCAG 2.1 Kontrastvorgaben
 */
export function Button({
  ...
  // Große Touch-Targets für ältere Nutzer (mindestens 44x44px gemäß WCAG)
  const sizeStyles = {
